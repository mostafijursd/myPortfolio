          ...
          <div className="w-[80%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide">
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                Hello, I'm Mostafijur Rahman, a React Js developer originally from West Bengal, India. Graduating with Honors
                 in Mathematics from Calcutta University in 2021. 
                </p>
              </div>
